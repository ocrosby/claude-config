...
> **Standards reference**: Your review criteria align with `go-conventions.md` (including its Project Structure, Error Handling, Documentation, and Security sections) and `go-testing.md`. When the checklist below and those rules diverge, the rules are the source of truth.
