...
> **Standards reference**: Your review criteria align with `go-conventions.md` and `go-testing.md`. When the checklist below and those rules diverge, the rules are the source of truth.
