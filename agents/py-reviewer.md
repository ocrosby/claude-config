...
> **Standards reference**: Your review criteria align with `py-conventions.md` (which now includes Project Structure), `py-testing.md`, and `py-security.md`. When the checklist below and those rules diverge, the rules are the source of truth.
