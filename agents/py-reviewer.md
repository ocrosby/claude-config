...
> **Standards reference**: Your review criteria align with `py-conventions.md` and `py-testing.md`. When the checklist below and those rules diverge, the rules are the source of truth.
