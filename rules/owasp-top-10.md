...
The OWASP Top 10 is a **recognition list**, not an implementation guide. This rule names the risks and the code-level signals that should trigger you to apply mitigations. For language-specific tactics see the Security section of `go-conventions.md`, `py-security.md`, and `nvim-security.md`.
