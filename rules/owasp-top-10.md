...
The OWASP Top 10 is a **recognition list**, not an implementation guide. This rule names the risks and the code-level signals that should trigger you to apply mitigations. For language-specific tactics see `go-security.md`, the Security section of `py-conventions.md`, and the Security section of `nvim-lua.md`.
